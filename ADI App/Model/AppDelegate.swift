...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if #available(iOS 13.0, *) {
            IQKeyboardManager.shared.toolbarBarTintColor = UIColor.systemBackground
        } else {
            // Fallback on earlier versions
        }
        ...
        UIToolbar.appearance().tintColor = UIColor.init(displayP3Red: 19.0/255.0, green: 152.0/255.0, blue: 223.0/255.0, alpha: 1)
        
        let navigationFont = UIFont(name: "Futura-CondensedExtraBold", size: 19)!
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "ADI_App")
